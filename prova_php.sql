...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/10/2023 às 06:53
...
(5, 150.00, '2023-10-04', 0, 1),
(6, 176.00, '1997-02-05', 0, 1),
(7, 165.00, '2023-10-01', 0, 1);
...
--
ALTER TABLE `tbl_conta_pagar`
  MODIFY `id_conta_pagar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
